...
return [
    [
        ...
        'child' => [
            ...
            ['left' => true, 'name' => 'All Group Admins', 'route' => 'group.index', 'icon' => 'fa-globe'],
            ...
            ['left' => true, 'name' => 'Fingerprint', 'route' => 'fingerprint.index', 'icon' => 'fa-thumbs-o-up'],
        ],
    ],
    [
        'name'  => 'Group admin',
        'child' => [
            ['top' => true, 'name' => 'Group Admins', 'route' => 'group.edit', 'icon' => 'fa-globe'],
