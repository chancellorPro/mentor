...
class CmsUser extends Authenticatable
{
    ...
    const ADMIN = 'admin';
    const TROPHY_CUP_MANAGER  = 'trophy';
    const CERTIFICATE_MANAGER = 'certificate';
    const FB_GROUPS_MANAGER   = 'group_admin';
    const GROUP_EVENT_MANAGER = 'special_prize';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function linkPc1()
    {
        return $this->hasOne(LinkPc1::class, 'user_id');
    }
