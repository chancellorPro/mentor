                                    ...
                                    @foreach($assets as $item)
                                        <tr class="fast-save-container">
                                            ...
                                            <td>
                                                ...
                                                <div class="list-thumbnail" data-toggle="popover" data-full="{{ env('CDN_URL') . '/' . $item->preview_url }}">
                                                    <img class="img-responsive" src="{{ env('CDN_URL') . '/' . $item->preview_url }}" title="{{$item->name}}">
                                                </div>
