        ...
        <div class="item active">
            <div class="row">
                ...
                <div 
                    ...
                    @endif
                    >
                    <a href="{{ env('CDN_URL') . '/' . $image->{$url} }}" data-toggle="lightbox" data-gallery="gallery-{{ $id }}">
                        <img src="{{ env('CDN_URL') . '/' . $image->{$url} }}" alt="{{ $image->{$name} }}" title="{{ $image->{$name} }}" class="img-responsive">
                    </a>
                </div>
